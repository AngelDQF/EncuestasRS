...
const ctrGetFuentesFinanciamientos = async (req, res) => {//TODO: Controlador para hacer get a los Fuentes de Financiamientos
  try {
    financiamientosModel.getFuentesFinanciamientos().then(result => {//TODO: Ejecutamos la funcion getBosuqes del modelo
      res.json({ results: result })//TODO: Mostramos el resultado en un json
    });
  } catch {
...
const ctrGetFuentesFinanciamientosDesactivados = async (req, res) => {//TODO: Funcion para hacer get a los Fuentes de Financiamientos Desactivados
  try {
    financiamientosModel.getFuentesFinanciamientosDesactivados().then(result => {//TODO: Ejecutamos la funcion getSuelos del modelo
      res.json({ results: result })//TODO: Mostramos el resultado en un json
    });
  } catch {
...
module.exports = { ctrGetTiposFinanciamientos, ctrGetTiposFinanciamientosDesactivados, ctrGetFuentesFinanciamientos, ctrGetFuentesFinanciamientosDesactivados };//TODO: Exportamos las funciones del controlador