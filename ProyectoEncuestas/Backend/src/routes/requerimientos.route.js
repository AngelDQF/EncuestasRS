...
router.get('/mercados', authMiddleware,checkTipo(["Admin"]), ctrGetMercados);//TODO: Creamos la ruta de tipo get para listar todos los Tipos de Financiamientos
...
router.get('/tierras/usos',authMiddleware,checkTipo(["Admin"]),  ctrGetUsosTierra);//TODO: Creamos la ruta de tipo get para listar todos los Fuentes de Financiamientos
...
router.get('/estructuras', authMiddleware,checkTipo(["Admin"]), ctrGetEstructuras);//TODO: Creamos la ruta de tipo get para listar todos los Fuentes de Financiamientos
...
router.get('/tierras/tenencia',authMiddleware,checkTipo(["Admin"]),  ctrGetTenenciaTierra);//TODO: Creamos la ruta de tipo get para listar todos los Fuentes de Financiamientos
