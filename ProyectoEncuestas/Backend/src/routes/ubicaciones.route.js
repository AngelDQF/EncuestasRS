...
router.get('/municipios',authMiddleware,checkTipo(["Admin","Encuestador"]),  ctrGetMunicipios);//TODO: Creamos la ruta de tipo get para listar todos los Municipios
router.get('/aldeas', authMiddleware,checkTipo(["Admin","Encuestador"]), ctrGetAldeas);//TODO: Creamos la ruta de tipo get para listar todas las Aldeas
router.get('/caserios', authMiddleware,checkTipo(["Admin"],"Encuestador"), ctrGetCaserios);//TODO: Creamos la ruta de tipo get para listar todos los Caserios
router.post('/asignar/mun',authMiddleware,checkTipo(["Admin"],"Encuestador"), ctrGetUbicacionesSinAsignar);
